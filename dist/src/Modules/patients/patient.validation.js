...
const addPatientValidation = joi.object({
    ...
    phone: joi.string().required()
        .pattern(/^\+?[1-9]\d{9,14}$/)
        .messages({
        'string.pattern.base': 'Phone number must be a valid international number (E.164 format)',
...
export { validateParamsId, addPatientValidation, updatePatientValidation };
