...
type GetMedicalRecordGroupByPayload<T extends MedicalRecordGroupByArgs> = Prisma.PrismaPromise<Array<Prisma.PickEnumerable<MedicalRecordGroupByOutputType, T['by']> & {
...
export type MedicalRecordOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"id" | "patientId" | "doctorId" | "diagnosis" | "treatment" | "createdAt" | "updatedAt", ExtArgs["result"]["medicalRecord"]>;
